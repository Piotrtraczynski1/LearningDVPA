...
Zapytania o należenie nie są kosztowne w przypadku rozważanego algorytmu,
...
\begin{enumerate}
    \item Zastosowany odpowiednik Twierdzenia Myhilla-Nerode'a dla automatów visibly pushdown nie jest prawą kongruencją.
    Oznacza to, że dwie różne konfiguracje hipotezy $H$ mogą być nierozróżnialne na podstawie dalszego zachowania automatu.
    Innymi słowy, rozpoczynając działanie z jednej z tych konfiguracji, hipoteza może rozpoznawać ten sam język,
    co przy rozpoczęciu działania z drugiej konfiguracji.
    Dlatego znalezienie reguły $r \to l \in R$ oraz konfiguracji $(q, s)$, takich że konfiguracje $H(q, l, s)$ i $H(q, r, s)$
