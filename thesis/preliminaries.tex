...
\textbf{System Przepisywania Słów (ang. String Rewriting System)} $R$ dalej SRS $R$ nazywamy zbiór reguł typu $l \rightarrow r$,
gdzie $l$ oraz $r$ są słowami nad pewnym alfabetem $\Sigma$. W tej pracy reguły SRS będą interpretowane jako więzy względem języka $L$:
reguła $l \to r$ oznacza, że dla wszystkich $w,v \in \Sigma^*$ zachodzi $wlv \in L \Leftrightarrow wrv \in L$.
