...
\cite[3.1 Difficulty of adapting $L^*$ to visibly pushdown languages]{main} dlatego algorytm modyfikuje stos automatu w trakcie wczytywania słowa.
...
W następnym rozdziale przedstawiono konkretną relacje zaproponowaną przez autorów, która została zaimplementowana.