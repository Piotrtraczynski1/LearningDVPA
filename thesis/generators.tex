...
Sekcja ta zawiera opisy trzech rodzajów automatów, które były generowane w celu utworzenia automatów wraz z systemem SRS wynikającym z jego struktury, która
...
\textbf{Cancellation} jest to klasa automatów dla których możliwym jest dla pewnych symboli $c \in \Sigma_{call}$ oraz $r \in \Sigma_{return}$ zdefiniowanie
...
tak jak ponowne zastosowanie już aktywnego pogrubienia tekstu.