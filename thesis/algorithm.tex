...
Następnym rozważanym pomysłem, było utrzymywanie struktury wykluczonych przejść, dla symobli return oraz odwoływanie się do niej,
...
kontrprzykładu. Nie udało się udowonić poprawności tego rozwiązania, jednak nie zostały wykryte żadne przypadki testowe świadczące
o niepoprawności tego rozwiązania.
...
Ilość produkcji udało się zredukować w przybliżeniu o jedną trzecią poprzez wykonanie przeszukiwania wszerz po nieterminalach zaczynając
