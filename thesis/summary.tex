...
uczenia automatów, a następnie opisano zaimplementowane algorytmy.
Omówiono również najważniejsze decyzje implementacyjne oraz moduły
...
Dodatkowa analiza czasu działania pokazała, że sama liczba zapytań o równoważność
nie wyjaśnia w pełni całkowitego czasu uczenia. Istotne znaczenie ma również struktura
przejść automatu docelowego, która może oddziaływać zarówno na koszt poszczególnych
procedur, jak i na liczbę wymaganych zapytań.
W szczególności automaty o bardziej rozbudowanej strukturze przejść mogą wymagać
mniejszej liczby zapytań o równoważność, a jednocześnie dłuższego całkowitego czasu uczenia.
