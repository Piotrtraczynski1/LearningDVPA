...
We apply this method to extend the Angluin-style active learning framework for VPLs by incorporating deductive inference from rewrite rules. 
String rewriting rules encode prior knowledge about the target language and  
