...
We iterate over all possible assignments from variables of $\lhs \to \rhs$ to $\BalReach$. 
...
\todo{reorder the following --- coNP more important}
...
For new call letter $\call_i$ the transition over $\call_i$ simulates reading the word $c_i v_{k+i}$ on the first component and $c_i' v_{i+k}'$ on the second component.
