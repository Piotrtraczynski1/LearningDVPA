...
The number of well-matched words used as substitutions for the variable in the rewrite rule was limited to $40$.
...
%due to very low cost of evaluation of a word in a \DVPA.
%If the evaluation of words becomes more expensive (e.g. LLM as a membership oracle), the overhead of our method vanishes. 
This suggests that \SRS is a useful feature in a heuristic approach.
